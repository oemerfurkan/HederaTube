...
console.info(
  `Hedera facilitator account: ${process.env.HEDERA_ACCOUNT_ID} (${NETWORK})`,
);
console.info(
  authorizerSigner
...
facilitator.register(
  NETWORK,
  new BatchSettlementHederaScheme(signer, authorizerSigner),
);
...
app.listen(parseInt(PORT), () => {
  console.log(
    `🚀 Hedera batch-settlement facilitator listening on http://localhost:${PORT}`,
  );
});
