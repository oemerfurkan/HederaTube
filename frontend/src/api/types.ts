...
export type Me = {
  address: string;
  verified: boolean;
  creator: { handle: string; display_name: string; description: string; hedera_account_id: string; avatar_url?: string } | null;
  spent_today: string;
};

export type ChannelResponse = {
  creator: { handle: string; display_name: string; description: string; hedera_account_id: string; avatar_url?: string };
  videos: Video[];
  total_earned: string;
  sessions: number;
};
